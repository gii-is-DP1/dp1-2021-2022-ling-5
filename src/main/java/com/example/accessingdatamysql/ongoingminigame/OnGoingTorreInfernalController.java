...
public class OnGoingTorreInfernalController {
    ...
    public @ResponseBody OnGoingTorreInfernal createGame(@RequestBody Request request) {
        onGoinTorreInfernalService.creatGame(request.getGameId(), gameService.findGame(request.getGameId()).get(),
    ...
    public @ResponseBody OnGoingTorreInfernal newCenterCard(@RequestBody RequestNewCard request,
