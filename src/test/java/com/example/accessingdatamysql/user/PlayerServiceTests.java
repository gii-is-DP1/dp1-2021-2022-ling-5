...
public class PlayerServiceTests {
    ...
    public void shouldInsertPlayer() {
        ...
        Player player = new Player("Uno", "uno", "uno", "uno@gmail.com", "unito", PlayerState.NO_PLAY);
    ...
    void shouldDeletePlayer() {
        Player player = new Player("Dos", "dos", "dos", "dos@gmail.com", "dosito", PlayerState.NO_PLAY);
